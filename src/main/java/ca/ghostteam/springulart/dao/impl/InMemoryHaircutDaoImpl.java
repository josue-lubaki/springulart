...
//
//        // keep the same ID as the old one
//        haircutModelUpdated.setId(oldHaircutModel.get().getId());
//
//        // set information
//        LIST_HAIRCUTS.set(index, haircutModelUpdated);
//
//        return Optional.of(LIST_HAIRCUTS.get(index));
//    }
//
//    // sample data
